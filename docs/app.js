...
const I18N = {
  es: {
    ...
    how_layer3: "<strong>Ritmo, forma y discurso.</strong> Cadencia plana, párrafos que no giran, temas sobreexplicados y cierres demasiado prolijos.<small>Integra señales de Pangram, StoryScope, humanizer y stop-slop sin caja negra.</small>",
    ...
    stripTip: "Quita caracteres invisibles y, si quieres, reescribe el texto para que suene menos a plantilla. Solo se usa si lo pides.",
  ...
  en: {
    ...
    how_layer3: "<strong>Rhythm, shape & discourse.</strong> Flat cadence, paragraphs that never turn, over-explained themes, and endings that are too neat.<small>Pangram, StoryScope, humanizer and stop-slop signals without a black box.</small>",
    ...
    stripTip: "Removes invisible characters and, if you want, rewrites the text so it sounds less like a template. Only runs when you ask for it.",
