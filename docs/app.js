...
const I18N = {
  es: {
    ...
    biblio_rep_footer: "generado por aismell · todo corre en tu navegador",
  ...
  en: {
    ...
    biblio_rep_footer: "generated by aismell · runs entirely in your browser",
...
<div class="stats">
  <div class="stat ok"><div class="num">${stats.exists}</div><div class="lbl">${escape(t.biblio_sum_verified)}</div></div>
  <div class="stat err"><div class="num">${stats.not_found}</div><div class="lbl">${escape(t.biblio_sum_not_found)}</div></div>
  <div class="stat warn"><div class="num">${stats.unverifiable}</div><div class="lbl">${escape(t.biblio_sum_unverifiable)}</div></div>
  <div class="stat warn"><div class="num">${stats.error}</div><div class="lbl">${escape(t.biblio_sum_error)}</div></div>
</div>
